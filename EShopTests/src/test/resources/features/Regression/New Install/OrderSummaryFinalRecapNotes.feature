...
Feature: As a SIMONG Representative,  I want system to display the order information recap about the order, installation date, Tax information, ect  so that i can confirm all the information with the customer

  #TC242511
  @orderSummaryFinalRecapNotes
  Scenario Outline: Login as a valid user and create an order and validate address and due date
    ...
    Then I validate address and dueDate with "<address>"
