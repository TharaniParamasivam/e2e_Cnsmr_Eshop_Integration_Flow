...
Feature: As a customer I want to create an Order with Central Address

  #TC244202
  @eshopcentral
  Scenario Outline: Login as a valid user and Create an Order with Central Address
    ...
    Examples: 
      ...
      | Jones     | Smith    | 4029986730 | 3066 SHADY LN,LITTLETON,CO 80126,USA | STANDARD            | LEASE        | BASIC       |   02 |    02 | 1987 | 345038058 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |
