@EshopTestScripts @EShopFunctional @EShopF26526
Feature: HSI Order Scenarios

  #TC324938 MMP6974  MMP7398 - CR6141 - ORT Wave 2 order  fulfillment enhancements
  @HSI_VerifyPassword25
  Scenario Outline: Create a HSI new install Order "TC324938"
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 | 334 W HATCHER RD,PHOENIX,AZ 85021,USA | Ctl@Ctl.com | Automation123 | 4029986730 | STANDARD            |   02 |    02 | 1987 | 345038058 | 6011329842589845 |    37638 | 3 devices       | Basic ($0) |

  #TC324940
  @POTSOnly_VerifyPassword25
  Scenario Outline: Create a POTS Only Order "TC324940"
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 | 334 W HATCHER RD,PHOENIX,AZ 85021,USA | Ctl@Ctl.com | 4029986730 | STANDARD            |   02 |    02 | 1987 | 666150907 | 4485389438108352 |    37638 | No         | No                    | No                      | No Work Is Needed ($0)    | Automation123 |

  #TC324942
  @HSI+POTS_VerifyPassword25
  Scenario Outline: Create a HSI + POTS Order "TC324942"
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 | Home Phone with Unlimited LD | 334 W HATCHER RD,PHOENIX,AZ 85021,USA | Ctl@Ctl.com | 4029986730 | STANDARD            |   02 |    02 | 1987 | 666150907 | 4485389438108352 |    37638 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | Automation123 | Basic ($0) |

  #TC324945
  @HSICVOIP_VerifyPassword25
  Scenario Outline: Create a HSI + CVOIP new install Order with Payment "TC324945"
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4899999343 | 334 W HATCHER RD,PHOENIX,AZ 85021,USA | Ctl@Ctl.com | 4029986730 | STANDARD            |   02 |    02 | 1987 | 345038058 | 4485389438108352 |    37638 | 2 devices       | Automation123 | Basic ($0) |
