@EshopTestScripts @TC379473
Feature: F26407-TC379473-Verify CNUM response is status = Available

  @TC379473-Verify_CNUM_response_is_status=Available
  Scenario Outline: F26407-TC379473-Verify CNUM response is status = Available
    ...
    Then I Select "402" from NPA "359" from NXX dropdown and "8888" as line
    Then I Click on CheckTN button
    Then I Validated the CNUM response message that says "TN is available"
    ...
    Examples: 
      ...
      | Test1 | Jones     | Smith    | 4029986730 | 311 S MAYNE ST,VALLEY,NE,68064,USA |      578581196 | STANDARD            | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    |
