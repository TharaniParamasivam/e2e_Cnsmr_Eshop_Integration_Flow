...
Feature: MACD Scenarios on Change Add
  ...
  #ATC_MACD_11
  @ATC_MACD_11
  Scenario Outline: MACD H S I during  CH  add POTS
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 |      578494441 |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | No         | No                    | No                      | No Work Is Needed ($0)    |

  #ATC_MACD_12
  @ATC_MACD625
  Scenario Outline: MACD  H S I  during  CH add CVOIP
    Given I should be on SFC login screen
    When I enter username and password
    #Below two commented steps are Future Ready steps for MACD Scenarios
    #Then I move back to existing SFC page
    ...
    Examples: 
      ...
      | ITV1 | Jones     | Smith    | 4029986736 |   578343278 |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 |

  #ATC_MACD_13
  @ATC_MACD_13
  Scenario Outline: MACD POTS during  CH  Add H S I
    Given I should be on SFC login screen
    When I enter username and password
    #Below two commented steps are Future Ready steps for MACD Scenarios
    #Then I move back to existing SFC page
 ...
 Scenario Outline: MACD  H S I  during  CH add CVOIP
  ...
  Scenario Outline: MACD  POTS during  CH  Add H S I
    ...
    Examples: 
      | Env | firstName | lastName | phoneNo    | account number | Date | Month | Year | SSN       | card             | zip code |
      | E2E | Jones     | Smith    | 4029986730 |      578494350 |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 |
