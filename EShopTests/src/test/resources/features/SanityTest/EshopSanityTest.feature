...
Feature: Order Creation and Order Completion
  ...
  #TC
  @HSILQOrderCompletionEshopSanity @EshopSanity000
  ...
  Scenario Outline: Create a HSI LC Postpaid Order
    ...
    Examples: 
      | firstName | lastName | phoneNo    | address                              | PostPaid Offer          | Installation_option | Modem_Option | Ease_Option | Date | Month | Year | SSN       | card             | zip code | Device Quantity | Additional Order Remarks       |
      | Brent     | Mayes    | 4029986730 | 1924 HYDE AVE,LA CROSSE,WI 54601,USA | PFL Internet up to 140M | Standard            | Purchase     | Basic       |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSICVOIPOrderCompletionEshopSanity
  Scenario Outline: Create a HSI + CVOIP Postpaid Order and Provisioning it
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | 2319 10TH ST,CORALVILLE,IA 52241,USA | PFL Internet up to 140M | Standard            | Purchase     | Basic       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 3 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSIPOTS_Home_Phone_with_Unlimited_LDOrderCompletionEshopSanity
  Scenario Outline: Create a HSI + POTS Postpaid Order and Provisioning it
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | Home Phone with Unlimited LD | PFL CenturyLink High Speed Internet | 2319 10TH ST,CORALVILLE,IA 52241,USA | Standard            | Purchase     | Basic       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @POTSonlyOrderCompletionEshopSanity
  Scenario Outline: Create a POTS only Postpaid Order and Provisioning it
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | 3066 SHADY LN,LITTLETON,CO 80126,USA | PFL Internet up to 140M | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |
