@EshopTestScripts @EShopOrderCompletionSanity
Feature: Order Creation and Order Completion

  #TC
  @HSILQOrderCompletionSanity
  Scenario Outline: Create a HSI LQ Postpaid Order and Provisioning it
    ...
    Examples: 
      ...
      # | Brent     | Mayes    | 4029986730 | 3066 SHADY LN,LITTLETON,CO 80126,USA | PFL Internet up to 140M             | Standard            | Lease        | Basic       |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |
      | Brent     | Mayes    | 4029986730 | 2319 10TH ST,CORALVILLE,IA 52241,USA | PFL CenturyLink High Speed Internet | Standard            | Lease        | Basic       |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSILCOrderCompletionSanity
  Scenario Outline: Create a HSI LC Postpaid Order
    ...
    Examples: 
      | firstName | lastName | phoneNo    | address                            | PostPaid Offer                      | Installation_option | Modem_Option | Ease_Option | Date | Month | Year | SSN       | card             | zip code | Device Quantity | Additional Order Remarks       |
      | Brent     | Mayes    | 4029986730 | 107 VINE ST,LA CROSSE,WI 54601,USA | PFL CenturyLink High Speed Internet | Standard            | Lease        | Basic       |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSICVOIPOrderCompletionSanity
  Scenario Outline: Create a HSI + CVOIP Postpaid Order and Provisioning it
    Given I should be on SFC login screen
    When I enter username and password
    Then I click on create new account
    Then I enter the "<firstName>" "<lastName>" "<phoneNo>" and "<address>" in new acquisition page
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | 2319 10TH ST,CORALVILLE,IA 52241,USA | PFL CenturyLink High Speed Internet | Standard            | Lease        | Basic       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 3 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSIPOTS_Home_Phone_with_Unlimited_LDOrderCompletionSanity
  Scenario Outline: Create a HSI + POTS Postpaid Order and Provisioning it
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | Home Phone with Unlimited LD | PFL CenturyLink High Speed Internet | 2319 10TH ST,CORALVILLE,IA 52241,USA | Standard            | Lease        | Basic       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @POTSonlyOrderCompletionSanity
  Scenario Outline: Create a POTS only Postpaid Order and Provisioning it
    Given I should be on SFC login screen
    When I enter username and password
    Then I click on create new account
    Then I enter the "<firstName>" "<lastName>" "<phoneNo>" and "<address>" in new acquisition page
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | 2319 10TH ST,CORALVILLE,IA 52241,USA | PFL CenturyLink High Speed Internet | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |

  @EShop_Prepaid_HSI_NI_OrderSanity
  Scenario Outline: Create a HSI LQ Prepaid Order and Provisioning it
    ...
    Examples: 
      ...
      | Nitish    | Pattanaik | 4029986730 | 8832 S CARR WAY,LITTLETON,CO 80128, USA | CenturyLink Internet (PREPAID) | HSI Up to 60 Mbps/5 Mbps | Ctli@Ctl.com | 4029986730 | Standard            | Lease        | Basic       |   01 |    01 | 1990 | Nitish Pattanaik | 4485389438108352 |    37638 | 2 devices       | ESHOP PREPAID TEST BY AUTOMATION |
