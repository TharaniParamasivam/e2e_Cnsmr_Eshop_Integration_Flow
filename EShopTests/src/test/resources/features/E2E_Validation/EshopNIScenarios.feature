...
Feature: Order Creation and Order Completion
  ...
  @HSIPOTS_NI_E2E_Shakeout_Postpaid_LQ
  Scenario Outline: Create a HSI + POTS Postpaid Order and Provisioning it
    ...
    Then I save the Order and Ban in the excel_sheet with respect to "<territory>","<ToolENV>"
    ...
    #Then I Make payment using MYA "<address>","<Payment Mode>","<cardOrRoutingNumber>","<payAmount>"
    Examples: 
      | territory | firstName | lastName | phoneNo    | Matching Offers              | PostPaid Offer                      | Speed                    | address                              | Installation_option | Modem_Option | Ease_Option | email                    | SMSNo      | Date | Month | Year | SSN       | Device Quantity | Voice Mail | Wire Maintenance Plan | Port in a phone number? | Need new jacks or wiring? | Additional Order Remarks       | ToolENV | Payment Mode | cardOrRoutingNumber | Payment Amount |
      | LQ        | ISAAC     | NEWTON   | 4029986730 | Home Phone with Unlimited LD | PFL CenturyLink High Speed Internet | HSI Up to 40 Mbps/3 Mbps | 2319 10TH ST,CORALVILLE,IA 52241,USA | Standard            | Purchase     | Basic       | testhundredsixty@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION | Test1   | Card         |    6011481687436620 |          12.00 |

  # | LC | THOMAS    | MOSAIC   | 4029986730 | Home Phone with Unlimited LD | PFL CenturyLink High Speed Internet | HSI Up to 30 Mbps/1.5 Mbps |306 W AZURE AVE,NORTH LAS VEGAS,NV 89031,USA | Standard            | Purchase     | Basic       | t@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION | Test1   |Card | 6011481687436620 |  23.00 |
