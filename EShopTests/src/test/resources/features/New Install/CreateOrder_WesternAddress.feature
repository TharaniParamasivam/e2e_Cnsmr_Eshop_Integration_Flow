...
Feature: Login as a Valid User and Create an Order with Western Address

  #TC
  @eshopWestern
  Scenario Outline: Login as a Valid User and Create an Order with Western Address
    ...
    Examples: 
      ...
      | Jones     | Smith    | 4029986730 | 1072 E BURNSIDE ST,PORTLAND,OR 97214,USA | STANDARD            | LEASE        | BASIC       |   02 |    02 | 1987 | 345038058 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |
