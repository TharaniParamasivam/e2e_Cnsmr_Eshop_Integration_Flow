...
Feature: Payments-Credit Card- HSI

  #TC242509
  @payNow
  Scenario Outline: Pay Now for an Order for a User
    ...
    Examples: 
      | firstName | lastName | phoneNo    | address                                  | Installation_option | Modem_Option | Ease_Option | Date | Month | Year | SSN       | card             | zip code | Device Quantity |
      | Jones     | Smith    | 4029986730 | 1072 E BURNSIDE ST,PORTLAND,OR 97214,USA | STANDARD            | LEASE        | BASIC       |   02 |    02 | 1987 | 345038058 | 4485389438108352 |    37638 | 2 devices       |
