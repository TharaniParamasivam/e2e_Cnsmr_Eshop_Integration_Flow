...
Feature: HSI Order Scenarios
  ...
  Scenario Outline: Create a HSI new install Order
    ...
    Examples: 
      ...
      | Thomas    | Hilla    | 4899999343 | 3066 SHADY LN,LITTLETON,CO 80126,USA | Standard            | LEASE        | BASIC       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |
