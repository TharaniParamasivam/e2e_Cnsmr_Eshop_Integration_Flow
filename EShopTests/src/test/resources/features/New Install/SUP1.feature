...
Feature: SUP1(Cancel Order) Scenarios

  #TC
  @HSICancelOrder
  Scenario Outline: Create a HSI new install Order and cancel it
  ...
  #TC
  @HSICVOIPCancelOrder
  Scenario Outline: Create a HSI + CVOIP new install Order and cancel it
    Given I should be on SFC login screen
    When I enter username and password
    Then I click on create new account
    Then I enter the "<firstName>" "<lastName>" "<phoneNo>" and "<address>" in new acquisition page
  ...
  #TC
  @HSIPOTSCancelOrder
  Scenario Outline: Create a POTS Order and cancel it
    Given I should be on SFC login screen
    When I enter username and password
    Then I click on create new account
    Then I enter the "<firstName>" "<lastName>" "<phoneNo>" and "<address>" in new acquisition page
