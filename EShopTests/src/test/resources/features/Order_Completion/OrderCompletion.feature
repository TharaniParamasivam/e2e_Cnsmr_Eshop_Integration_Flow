@EshopTestScripts @EShopOrderCompletion
Feature: Order Creation and Order Completion

  @HSIOrderCompletion
  Scenario Outline: Login as a valid user and Create an Order with Central Address and complete it
    ...
    Then I select the Prepaid offer "<PostPaid Offer>"
    ...
    Examples: 
      ...
      | Brent     | Mayes    | 4029986730 | 3066 SHADY LN,LITTLETON,CO 80126,USA | PFL CenturyLink High Speed Internet | Standard            | LEASE        | BASIC       |   02 |    02 | 1987 | 666601283 | 4485389438108352 |    37638 | 2 devices       | ESHOP ORDER TEST BY AUTOMATION |

  @HSICVOIPOrderCompletion
  Scenario Outline: Create a HSI + CVOIP new install Order with No deposit required
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | 3066 SHADY LN,LITTLETON,CO 80126,USA | STANDARD            | LEASE        | BASIC       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 3 devices       | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @HSIPOTS_Home_Phone_with_Unlimited_LDOrderCompletion
  Scenario Outline: Create a HSI + POTS Order with No deposit required
    ...
    Examples: 
      ...
      | THOMAS    | HILLA    | 4029986730 | Home Phone with Unlimited LD | 3066 SHADY LN,LITTLETON,CO 80126,USA | STANDARD            | LEASE        | BASIC       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |

  @HSI+POTS_Essential_Home_PhoneOrderCompletion
  Scenario Outline: Create a HSI + POTS Order
    ...
    Examples: 
      | firstName | lastName | phoneNo    | Matching Offers      | address                              | Installation_option | Modem_Option | Ease_Option | email       | SMSNo      | Date | Month | Year | SSN       | Device Quantity | Voice Mail | Wire Maintenance Plan | Port in a phone number? | Need new jacks or wiring? | Additional Order Remarks       |
      | THOMAS    | HILLA    | 4029986730 | Essential Home Phone | 3066 SHADY LN,LITTLETON,CO 80126,USA | STANDARD            | LEASE        | BASIC       | Ctl@Ctl.com | 4029986730 |   02 |    02 | 1987 | 666446831 | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    | ESHOP ORDER TEST BY AUTOMATION |

  #TC
  @POTSonlyOrderCompletion
  ...
  #ATC00004
  @HomePhoneOnlyAccountsWithOne_Pty_Residence_LineOrderCompletion
